...
import com.example.gaursaurabh.faspire.ProfileYouthModel;
 ...
 */
public class YouthModelAdapter extends RecyclerView.Adapter<YouthModelAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public YouthModelAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileYouthModel.class);
                intent.putExtra("youthModelId",dataLists.get(position).getId());
