...
import com.example.gaursaurabh.faspire.ProfileMakeupArtist;
import com.example.gaursaurabh.faspire.ProfileProfessionalMakeup;
 ...
 */
public class ProfessionalMakeupArtistAdapter extends RecyclerView.Adapter<ProfessionalMakeupArtistAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public ProfessionalMakeupArtistAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileProfessionalMakeup.class);
                intent.putExtra("professionalMakeupArtistId",dataLists.get(position).getId());
