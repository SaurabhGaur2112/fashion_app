 ...
 */
public class ProfileMakeupArtistGetValue {

    public static String[] getvaluesMakeupArtists(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_makeup_artist.php");
