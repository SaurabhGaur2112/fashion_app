...
import com.example.gaursaurabh.faspire.ProfileFaspirePeople;
...
public class PeopleAdapter extends RecyclerView.Adapter<PeopleAdapter.ViewHolder> {
    ...
    public PeopleAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileFaspirePeople.class);
                intent.putExtra("faspirePeopleId",dataLists.get(position).getId());
