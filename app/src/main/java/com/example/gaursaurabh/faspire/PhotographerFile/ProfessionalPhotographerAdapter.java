...
import com.example.gaursaurabh.faspire.ProfilePhotography;
import com.example.gaursaurabh.faspire.ProfileProfessionalPhotographer;
 ...
 */
public class ProfessionalPhotographerAdapter extends RecyclerView.Adapter<ProfessionalPhotographerAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public ProfessionalPhotographerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileProfessionalPhotographer.class);
                intent.putExtra("professionalPhotographerId",dataLists.get(position).getId());
