package com.example.gaursaurabh.faspire.CelebrityDesignerFile;
 ...
 */
public class ProfileCelebrityDesignerGetValue {

    public static String[] getvaluesDesigner(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_celebrity_designer.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_gallery_first += json_data.getString("designer_gallery_image_first") + ":";
                temp_gallery_second += json_data.getString("designer_gallery_image_second") + ":";
                temp_gallery_third += json_data.getString("designer_gallery_image_third") + ":";
                temp_gallery_fourth += json_data.getString("designer_gallery_image_fourth") + ":";
                temp_gallery_fifth += json_data.getString("designer_gallery_image_fifth") + ":";
                temp_gallery_sixth += json_data.getString("designer_gallery_image_sixth") + ":";
