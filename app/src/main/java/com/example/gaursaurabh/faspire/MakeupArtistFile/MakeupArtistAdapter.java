 ...
 */
public class MakeupArtistAdapter extends RecyclerView.Adapter<MakeupArtistAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public MakeupArtistAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileMakeupArtist.class);
                intent.putExtra("makeupArtistId",dataLists.get(position).getId());
