...
public class DesignerAdapter extends RecyclerView.Adapter<DesignerAdapter.ViewHolder> {
    ...
    public DesignerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileDesigner.class);
                intent.putExtra("designerId",dataLists.get(position).getId());
