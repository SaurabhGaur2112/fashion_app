 ...
 */
public class ProfileProfessionalModelGetValue {

    public static String[] getvalueProfessionalModel(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        String temp_name = "",temp_profile_image = "",temp_gender = "",temp_city = "",
                ...
                temp_video_fifth = "",temp_video_sixth = "",temp_fb_icon = "",temp_tw_icon = "",temp_insta_icon = "",temp_web_icon = "";
        ...
        String[] arr_name,arr_profile_image,arr_gender,arr_city,arr_style,arr_language,arr_code,arr_year_active,
                ...
                ,arr_video_third,arr_video_fourth,arr_video_fifth,arr_video_sixth,arr_fb_icon,arr_tw_icon,arr_insta_icon,arr_web_icon;
        ...
        String getname = null,getprofile_image = null,getgender = null,getcity = null,getstyle = null,getlanguage = null
                ...
                ,getvideo_fifth = null,getvideo_sixth = null,getfb_icon = null,gettw_icon = null,getinsta_icon = null,getweb_icon = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_professional_model.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_name += json_data.getString("model_name") + ":";
                temp_profile_image += json_data.getString("model_image") + ":";
                temp_gender += json_data.getString("model_gender") + ":";
                temp_city += json_data.getString("model_city") + ":";
                temp_style += json_data.getString("model_style") + ":";
                temp_language += json_data.getString("model_language") + ":";
                temp_code += json_data.getString("model_code") + ":";
                temp_year_active += json_data.getString("model_year_active") + ":";
                temp_height += json_data.getString("model_height") + ":";
                temp_chest_brest += json_data.getString("model_chest_brest") + ":";
                temp_waste += json_data.getString("model_waste") + ":";
                temp_hair_color += json_data.getString("model_hair_color") + ":";
                temp_eye_color += json_data.getString("model_eye_color") + ":";
                temp_shoe_size += json_data.getString("model_shoe_size") + ":";
                temp_experience += json_data.getString("model_experience") + ":";
                temp_biography += json_data.getString("model_biography") + ":";
                temp_portfolio_first += json_data.getString("model_portfolio_first") + ":";
                temp_portfolio_second += json_data.getString("model_portfolio_second") + ":";
                temp_portfolio_third += json_data.getString("model_portfolio_third") + ":";
                temp_portfolio_fourth += json_data.getString("model_portfolio_fourth") + ":";
                temp_portfolio_fifth += json_data.getString("model_portfolio_fifth") + ":";
                temp_portfolio_sixth += json_data.getString("model_portfolio_sixth") + ":";
                temp_gallery_first += json_data.getString("model_gallery_first") + ":";
                temp_gallery_second += json_data.getString("model_gallery_second") + ":";
                temp_gallery_third += json_data.getString("model_gallery_third") + ":";
                temp_gallery_fourth += json_data.getString("model_gallery_fourth") + ":";
                temp_gallery_fifth += json_data.getString("model_gallery_fifth") + ":";
                temp_gallery_sixth += json_data.getString("model_gallery_sixth") + ":";
                temp_video_first += json_data.getString("model_video_first") + ":";
                temp_video_second += json_data.getString("model_video_second") + ":";
                temp_video_third += json_data.getString("model_video_third") + ":";
                temp_video_fourth += json_data.getString("model_video_fourth") + ":";
                temp_video_fifth += json_data.getString("model_video_fifth") + ":";
                temp_video_sixth += json_data.getString("model_video_sixth") + ":";
                temp_fb_icon += json_data.getString("model_fb") + ":";
                temp_tw_icon += json_data.getString("model_twitter") + ":";
                temp_insta_icon += json_data.getString("model_insta") + ":";
                temp_web_icon += json_data.getString("model_web") + ":";
