 ...
 */
public class ProfileFashionStudioGetValue {

    public static String[] getvaluesFashionStudio(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_studio_photographer.php");
