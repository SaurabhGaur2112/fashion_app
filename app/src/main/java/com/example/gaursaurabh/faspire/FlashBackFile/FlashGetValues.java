 ...
 */
public class FlashGetValues {

    public static String[] getvaluesFlash(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/show_flash.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_image += json_data.getString("flash_image") + ":";
                temp_headline += json_data.getString("flash_headline") + ":";
                //temp_description += json_data.getString("flash_description") + ":";
                temp_represent += json_data.getString("flash_represent") + ":";
                temp_video += json_data.getString("flash_video") + ":";
            }
