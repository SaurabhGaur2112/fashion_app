...
import com.example.gaursaurabh.faspire.ProfileTheatorActor;
 ...
 */
public class TheatorActorAdapter extends RecyclerView.Adapter<TheatorActorAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public TheatorActorAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileTheatorActor.class);
                intent.putExtra("theatorActorId",dataLists.get(position).getId());
