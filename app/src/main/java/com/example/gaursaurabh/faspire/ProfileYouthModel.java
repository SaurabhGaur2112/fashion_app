...
import com.example.gaursaurabh.faspire.ModelFile.ProfileYouthModelGetValue;
...
public class ProfileYouthModel extends YouTubeBaseActivity {
    ...
    Intent intent;
    String getId;
    String IMAGE_URL = "http://www.faspire.in/faspire_android/youth_model_image/";
    ProfileYouthModelGetValue profileYouthModelGetValue;
    String get_details[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_youth_model);
        ...
        profileYouthModelGetValue = new ProfileYouthModelGetValue();
        intent = getIntent();
        getId = intent.getStringExtra("youthModelId");

        profileImg = (ImageView) findViewById(R.id.youth_mod_profileImg);
        portfolioImgFirst = (ImageView) findViewById(R.id.youth_mod_portfolioFirst);
        portfolioImgSecond = (ImageView) findViewById(R.id.youth_mod_portfolioSecond);
        portfolioImgThird = (ImageView) findViewById(R.id.youth_mod_portfolioThird);
        portfolioImgFourth = (ImageView) findViewById(R.id.youth_mod_portfolioFourth);
        portfolioImgFifth = (ImageView) findViewById(R.id.youth_mod_portfolioFifth);
        portfolioImgSixth = (ImageView) findViewById(R.id.youth_mod_portfolioSixth);
        galleryImgFirst = (ImageView) findViewById(R.id.youth_mod_galleryFirst);
        galleryImgSecond = (ImageView) findViewById(R.id.youth_mod_gallerySecond);
        galleryImgThird = (ImageView) findViewById(R.id.youth_mod_galleryThird);
        galleryImgFourth = (ImageView) findViewById(R.id.youth_mod_galleryFourth);
        galleryImgFifth = (ImageView) findViewById(R.id.youth_mod_galleryFifth);
        galleryImgSixth = (ImageView) findViewById(R.id.youth_mod_gallerySixth);

        fbIcon = (ImageView) findViewById(R.id.youth_model_facebook_icon);
        twIcon = (ImageView) findViewById(R.id.youth_model_twitter_icon);
        instaIcon = (ImageView) findViewById(R.id.youth_model_instagram_icon);
        webIcon = (ImageView) findViewById(R.id.youth_model_website_icon);
        contactIcon = (ImageView) findViewById(R.id.youth_model_contact_icon);

        name = (TextView) findViewById(R.id.youth_mod_name);
        gender = (TextView) findViewById(R.id.youth_mod_gender);
        city = (TextView) findViewById(R.id.youth_mod_city);
        style = (TextView) findViewById(R.id.youth_mod_style);
        yearActive = (TextView) findViewById(R.id.youth_mod_yearActive);
        language = (TextView) findViewById(R.id.youth_mod_language);
        height = (TextView) findViewById(R.id.youth_mod_height);
        chestBrest = (TextView) findViewById(R.id.youth_mod_chestBrest);
        waste = (TextView) findViewById(R.id.youth_mod_waste);
        hairColor = (TextView) findViewById(R.id.youth_mod_hairColor);
        eyeColor = (TextView) findViewById(R.id.youth_mod_eyeColor);
        shoeSize = (TextView) findViewById(R.id.youth_mod_shoeSize);
        experience = (TextView) findViewById(R.id.youth_mod_experience);
        biography = (TextView) findViewById(R.id.youth_mod_biography);

        firstYouTube = (YouTubePlayerView) findViewById(R.id.youth_mod_videoFirst);

        if(cd.isConnected())
        {
            get_details = profileYouthModelGetValue.getvalueYouthModel(getId);
            ...
            Toast.makeText(ProfileYouthModel.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
        ...
        PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + profileImgTxt,profileImg);


        if(!portfolioImgFirstTxt.equals("null"))
        {
            portfolioImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgFirstTxt,portfolioImgFirst);
        }
        if(!portfolioImgSecondTxt.equals("null"))
        {
            portfolioImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgSecondTxt,portfolioImgSecond);
        }
        if(!portfolioImgThirdTxt.equals("null"))
        {
            portfolioImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgThirdTxt,portfolioImgThird);
        }
        if(!portfolioImgFourthTxt.equals("null"))
        {
            portfolioImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgFourthTxt,portfolioImgFourth);
        }
        if(!portfolioImgFifthTxt.equals("null"))
        {
            portfolioImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgFifthTxt,portfolioImgFifth);
        }
        if(!portfolioImgSixthTxt.equals("null"))
        {
            portfolioImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + portfolioImgSixthTxt,portfolioImgSixth);
        }
        if(!galleryFirstTxt.equals("null"))
        {
            galleryImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + galleryFirstTxt,galleryImgFirst);
        }
        if(!gallerySecondTxt.equals("null"))
        {
            galleryImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + gallerySecondTxt,galleryImgSecond);
        }
        if(!galleryThirdTxt.equals("null"))
        {
            galleryImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + galleryThirdTxt,galleryImgThird);
        }
        if(!galleryFourthTxt.equals("null"))
        {
            galleryImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + galleryFourthTxt,galleryImgFourth);
        }
        if(!galleryFifthTxt.equals("null"))
        {
            galleryImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + galleryFifthTxt,galleryImgFifth);
        }
        if(!gallerySixthTxt.equals("null"))
        {
            galleryImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileYouthModel.this,IMAGE_URL + gallerySixthTxt,galleryImgSixth);
        }
