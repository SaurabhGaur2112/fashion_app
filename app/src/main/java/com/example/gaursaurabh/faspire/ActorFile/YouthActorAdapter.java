...
import com.example.gaursaurabh.faspire.ProfileYouthActor;
 ...
 */
public class YouthActorAdapter extends RecyclerView.Adapter<YouthActorAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public YouthActorAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileYouthActor.class);
                intent.putExtra("youthActorId",dataLists.get(position).getId());
