...
public class ShowVideoNews extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_video_news);
        ...
        firstYouTube = (YouTubePlayerView) findViewById(R.id.newsshow_video);
        headline = (TextView) findViewById(R.id.newsshow_headline_video);
        description = (TextView) findViewById(R.id.newsshow_description_video);
        ...
        if(cd.isConnected())
        {
            ...
            Toast.makeText(ShowVideoNews.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
