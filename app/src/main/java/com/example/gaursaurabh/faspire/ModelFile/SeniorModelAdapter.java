...
import com.example.gaursaurabh.faspire.ProfileSeniorModel;
 ...
 */
public class SeniorModelAdapter extends RecyclerView.Adapter<SeniorModelAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public SeniorModelAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileSeniorModel.class);
                intent.putExtra("seniorModelId",dataLists.get(position).getId());
