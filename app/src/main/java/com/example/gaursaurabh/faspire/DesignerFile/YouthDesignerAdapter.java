...
import com.example.gaursaurabh.faspire.ProfileYouthDesigner;
 ...
 */
public class YouthDesignerAdapter extends RecyclerView.Adapter<YouthDesignerAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public YouthDesignerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileYouthDesigner.class);
                intent.putExtra("youthDesignerId",dataLists.get(position).getId());
