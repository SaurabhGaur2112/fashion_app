 ...
 */
public class ProfileYouthActorGetValue {

    public static String[] getvalueYouthActor(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_youth_actor.php");
