package com.example.gaursaurabh.faspire.PhotographerFile;
 ...
 */
public class ProfileProfessionalPhotographerGetValue {

    public static String[] getvaluesProfessionalPhotographer(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        String temp_name = "",temp_profile_image = "",temp_professional_skills = "",temp_year_active = "",
                temp_aboutus = "",temp_experience = "",temp_clients = "",temp_gallery_first = "",temp_gallery_second = ""
                ...
                ,temp_video_fifth = "",temp_video_sixth = "",temp_code = ""
                ,temp_fb_icon = "",temp_tw_icon = "",temp_insta_icon = "",temp_web_icon = "";

        String[] arr_name,arr_profile_image,arr_professional_skills,arr_year_active,arr_aboutus,arr_experience,arr_clients
                ...
                ,arr_code,arr_fb_icon,arr_tw_icon,arr_insta_icon,arr_web_icon;

        String getname = null,getprofile_image = null,getprofessional_skills = null,getyear_active = null
                ,getaboutus = null,getexperience = null,getclients = null,getgallery_first = null,getgallery_second = null
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_professional_photographer.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_name += json_data.getString("photographer_name") + ":";
                temp_profile_image += json_data.getString("photographer_profile_image") + ":";
                temp_professional_skills += json_data.getString("photographer_professtional") + ":";
                temp_year_active += json_data.getString("photographer_year_active") + ":";
                temp_aboutus += json_data.getString("photographer_aboutme") + ":";
                temp_experience += json_data.getString("photographer_experience") + ":";
                temp_clients += json_data.getString("photographer_clients") + ":";
                temp_gallery_first += json_data.getString("photographer_gallery_first") + ":";
                temp_gallery_second += json_data.getString("photographer_gallery_second") + ":";
                temp_gallery_third += json_data.getString("photographer_gallery_third") + ":";
                temp_gallery_fourth += json_data.getString("photographer_gallery_fourth") + ":";
                temp_gallery_fifth += json_data.getString("photographer_gallery_fifth") + ":";
                temp_gallery_sixth += json_data.getString("photographer_gallery_sixth") + ":";
                temp_gallery_seventh += json_data.getString("photographer_gallery_seventh") + ":";
                temp_gallery_eighth += json_data.getString("photographer_gallery_eighth") + ":";
                temp_gallery_ninth += json_data.getString("photographer_gallery_ninth") + ":";
                temp_gallery_tenth += json_data.getString("photographer_gallery_tenth") + ":";
                temp_video_first += json_data.getString("photographer_video_first") + ":";
                temp_video_second += json_data.getString("photographer_video_second") + ":";
                temp_video_third += json_data.getString("photographer_video_third") + ":";
                temp_video_fourth += json_data.getString("photographer_video_fourth") + ":";
                temp_video_fifth += json_data.getString("photographer_video_fifth") + ":";
                temp_video_sixth += json_data.getString("photographer_video_sixth") + ":";
                temp_code += json_data.getString("photographer_code") + ":";
                temp_fb_icon += json_data.getString("photographer_fb") + ":";
                temp_tw_icon += json_data.getString("photographer_twitter") + ":";
                temp_insta_icon += json_data.getString("photographer_insta") + ":";
                temp_web_icon += json_data.getString("photographer_web") + ":";
        ...
        return new String[]
                {
                        getname,getprofile_image,getprofessional_skills,getyear_active,getaboutus,getexperience,getclients
                        ...
                        ,getcode,getfb_icon,gettw_icon,getinsta_icon,getweb_icon
                };
    }
}
