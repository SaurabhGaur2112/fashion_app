...
public class ProfileActor extends YouTubeBaseActivity {
    ...
    Intent intent;
    String getId;
    String IMAGE_URL = "http://www.faspire.in/faspire_android/actor_image/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        getId = intent.getStringExtra("actorId");


        profileImg = (ImageView) findViewById(R.id.ac_profileImg);
        portfolioImgFirst = (ImageView) findViewById(R.id.ac_portfolioImgFirst);
        portfolioImgSecond = (ImageView) findViewById(R.id.ac_portfolioImgSecond);
        portfolioImgThird = (ImageView) findViewById(R.id.ac_portfolioImgThird);
        portfolioImgFourth = (ImageView) findViewById(R.id.ac_portfolioImgFourth);
        portfolioImgFifth = (ImageView) findViewById(R.id.ac_portfolioImgFifth);
        portfolioImgSixth = (ImageView) findViewById(R.id.ac_portfolioImgSixth);
        galleryImgFirst = (ImageView) findViewById(R.id.ac_galleryImgFirst);
        galleryImgSecond = (ImageView) findViewById(R.id.ac_galleryImgSecond);
        galleryImgThird = (ImageView) findViewById(R.id.ac_galleryImgThird);
        galleryImgFourth = (ImageView) findViewById(R.id.ac_galleryImgFourth);
        galleryImgFifth = (ImageView) findViewById(R.id.ac_galleryImgFifth);
        galleryImgSixth = (ImageView) findViewById(R.id.ac_galleryImgSixth);

        name = (TextView) findViewById(R.id.ac_name);
        gender = (TextView) findViewById(R.id.ac_gender);
        city = (TextView) findViewById(R.id.ac_city);
        style = (TextView) findViewById(R.id.ac_style);
        yearActive = (TextView) findViewById(R.id.ac_yearActive);
        language = (TextView) findViewById(R.id.ac_language);
        height = (TextView) findViewById(R.id.ac_height);
        chestBrest = (TextView) findViewById(R.id.ac_chestBrest);
        waste = (TextView) findViewById(R.id.ac_waste);
        hairColor = (TextView) findViewById(R.id.ac_hairColor);
        eyeColor = (TextView) findViewById(R.id.ac_eyeColor);
        shoeSize = (TextView) findViewById(R.id.ac_shoeSize);
        experience = (TextView) findViewById(R.id.ac_experience);3
        biography = (TextView) findViewById(R.id.ac_biography);

        firstYouTube = (YouTubePlayerView) findViewById(R.id.ac_videoFirst);
        ...
        if(cd.isConnected())
        {
            ...
            Toast.makeText(ProfileActor.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
        ...
        PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + profileImgTxt,profileImg);

        if(!portfolioImgFirstTxt.equals("null"))
        {
            portfolioImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgFirstTxt,portfolioImgFirst);
        }
        if(!portfolioImgSecondTxt.equals("null"))
        {
            portfolioImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgSecondTxt,portfolioImgSecond);
        }
        if(!portfolioImgThirdTxt.equals("null"))
        {
            portfolioImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgThirdTxt,portfolioImgThird);
        }
        if(!portfolioImgFourthTxt.equals("null"))
        {
            portfolioImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgFourthTxt,portfolioImgFourth);
        }
        if(!portfolioImgFifthTxt.equals("null"))
        {
            portfolioImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgFifthTxt,portfolioImgFifth);
        }
        if(!portfolioImgSixthTxt.equals("null"))
        {
            portfolioImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + portfolioImgSixthTxt,portfolioImgSixth);
        }
        if(!galleryFirstTxt.equals("null"))
        {
            galleryImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + galleryFirstTxt,galleryImgFirst);
        }
        if(!gallerySecondTxt.equals("null"))
        {
            galleryImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + gallerySecondTxt,galleryImgSecond);
        }
        if(!galleryThirdTxt.equals("null"))
        {
            galleryImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + galleryThirdTxt,galleryImgThird);
        }
        if(!galleryFourthTxt.equals("null"))
        {
            galleryImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + galleryFourthTxt,galleryImgFourth);
        }
        if(!galleryFifthTxt.equals("null"))
        {
            galleryImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + galleryFifthTxt,galleryImgFifth);
        }
        if(!gallerySixthTxt.equals("null"))
        {
            galleryImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileActor.this,IMAGE_URL + gallerySixthTxt,galleryImgSixth);
        }
