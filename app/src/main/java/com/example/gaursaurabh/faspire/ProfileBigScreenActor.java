...
import com.example.gaursaurabh.faspire.ActorFile.ProfileBigScreenActorGetValue;
...
public class ProfileBigScreenActor extends YouTubeBaseActivity {
    ...
    Intent intent;
    String getId;
    String IMAGE_URL = "http://www.faspire.in/faspire_android/bigscreen_actor_image/";
    ProfileBigScreenActorGetValue profileBigScreenActorGetValue;
    String get_details[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_big_screen_actor);
        ...
        profileBigScreenActorGetValue = new ProfileBigScreenActorGetValue();
        intent = getIntent();
        getId = intent.getStringExtra("bigScreenActorId");


        profileImg = (ImageView) findViewById(R.id.screen_ac_profileImg);
        portfolioImgFirst = (ImageView) findViewById(R.id.screen_ac_portfolioImgFirst);
        portfolioImgSecond = (ImageView) findViewById(R.id.screen_ac_portfolioImgSecond);
        portfolioImgThird = (ImageView) findViewById(R.id.screen_ac_portfolioImgThird);
        portfolioImgFourth = (ImageView) findViewById(R.id.screen_ac_portfolioImgFourth);
        portfolioImgFifth = (ImageView) findViewById(R.id.screen_ac_portfolioImgFifth);
        portfolioImgSixth = (ImageView) findViewById(R.id.screen_ac_portfolioImgSixth);
        galleryImgFirst = (ImageView) findViewById(R.id.screen_ac_galleryImgFirst);
        galleryImgSecond = (ImageView) findViewById(R.id.screen_ac_galleryImgSecond);
        galleryImgThird = (ImageView) findViewById(R.id.screen_ac_galleryImgThird);
        galleryImgFourth = (ImageView) findViewById(R.id.screen_ac_galleryImgFourth);
        galleryImgFifth = (ImageView) findViewById(R.id.screen_ac_galleryImgFifth);
        galleryImgSixth = (ImageView) findViewById(R.id.screen_ac_galleryImgSixth);

        fbIcon = (ImageView) findViewById(R.id.big_screen_facebook_icon);
        twIcon = (ImageView) findViewById(R.id.big_screen_twitter_icon);
        instaIcon = (ImageView) findViewById(R.id.big_screen_instagram_icon);
        webIcon = (ImageView) findViewById(R.id.big_screen_website_icon);
        contactIcon = (ImageView) findViewById(R.id.big_screen_contact_icon);

        name = (TextView) findViewById(R.id.screen_ac_name);
        gender = (TextView) findViewById(R.id.screen_ac_gender);
        city = (TextView) findViewById(R.id.screen_ac_city);
        style = (TextView) findViewById(R.id.screen_ac_style);
        yearActive = (TextView) findViewById(R.id.screen_ac_yearActive);
        language = (TextView) findViewById(R.id.screen_ac_language);
        height = (TextView) findViewById(R.id.screen_ac_height);
        chestBrest = (TextView) findViewById(R.id.screen_ac_chestBrest);
        waste = (TextView) findViewById(R.id.screen_ac_waste);
        hairColor = (TextView) findViewById(R.id.screen_ac_hairColor);
        eyeColor = (TextView) findViewById(R.id.screen_ac_eyeColor);
        shoeSize = (TextView) findViewById(R.id.screen_ac_shoeSize);
        experience = (TextView) findViewById(R.id.screen_ac_experience);
        biography = (TextView) findViewById(R.id.screen_ac_biography);

        firstYouTube = (YouTubePlayerView) findViewById(R.id.screen_ac_videoFirst);

        if(cd.isConnected())
        {

            get_details = profileBigScreenActorGetValue.getvalueBigScreenActor(getId);
            ...
            Toast.makeText(ProfileBigScreenActor.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
        ...
        PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + profileImgTxt,profileImg);

        if(!portfolioImgFirstTxt.equals("null"))
        {
            portfolioImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgFirstTxt,portfolioImgFirst);
        }
        if(!portfolioImgSecondTxt.equals("null"))
        {
            portfolioImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgSecondTxt,portfolioImgSecond);
        }
        if(!portfolioImgThirdTxt.equals("null"))
        {
            portfolioImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgThirdTxt,portfolioImgThird);
        }
        if(!portfolioImgFourthTxt.equals("null"))
        {
            portfolioImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgFourthTxt,portfolioImgFourth);
        }
        if(!portfolioImgFifthTxt.equals("null"))
        {
            portfolioImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgFifthTxt,portfolioImgFifth);
        }
        if(!portfolioImgSixthTxt.equals("null"))
        {
            portfolioImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + portfolioImgSixthTxt,portfolioImgSixth);
        }
        if(!galleryFirstTxt.equals("null"))
        {
            galleryImgFirst.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + galleryFirstTxt,galleryImgFirst);
        }
        if(!gallerySecondTxt.equals("null"))
        {
            galleryImgSecond.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + gallerySecondTxt,galleryImgSecond);
        }
        if(!galleryThirdTxt.equals("null"))
        {
            galleryImgThird.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + galleryThirdTxt,galleryImgThird);
        }
        if(!galleryFourthTxt.equals("null"))
        {
            galleryImgFourth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + galleryFourthTxt,galleryImgFourth);
        }
        if(!galleryFifthTxt.equals("null"))
        {
            galleryImgFifth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + galleryFifthTxt,galleryImgFifth);
        }
        if(!gallerySixthTxt.equals("null"))
        {
            galleryImgSixth.setVisibility(View.VISIBLE);
            PicassoClient.downloadImgae(ProfileBigScreenActor.this,IMAGE_URL + gallerySixthTxt,galleryImgSixth);
        }
