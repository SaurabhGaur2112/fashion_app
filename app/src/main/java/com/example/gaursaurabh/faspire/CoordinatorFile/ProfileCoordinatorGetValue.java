 ...
 */
public class ProfileCoordinatorGetValue {

    public static String[] getvaluesCoordinator(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        String temp_name = "",temp_profile_image = "",temp_year_active = "",temp_city = "",
                temp_area = "",temp_code = "",temp_aboutus = "",temp_image_first = "",temp_image_second = "",
        ...
        String[] arr_name,arr_profile_image,arr_year_active,arr_city,arr_area,arr_code,arr_aboutus,arr_image_first
                ,arr_image_second,arr_image_third,arr_image_fourth,arr_image_fifth,arr_image_sixth
                ,arr_gallery_first,arr_gallery_second,arr_gallery_third,arr_gallery_fourth,arr_gallery_fifth
                ,arr_gallery_sixth,arr_video_first,arr_video_second,arr_video_third,arr_video_fourth,arr_video_fifth
                ,arr_video_sixth,arr_fb_icon,arr_tw_icon,arr_insta_icon,arr_web_icon;

        String getname = null,getprofile_image = null,getyear_active = null,getcity = null,getarea = null,getcode = null
                ,getaboutus = null,getimage_first = null,getimage_second = null,getimage_third = null,getimage_fourth = null
                ,getimage_fifth = null,getimage_sixth = null,getgallery_first = null,getgallery_second = null,getgallery_third = null
                ,getgallery_fourth = null,getgallery_fifth = null,getgallery_sixth = null,getvideo_first = null,getvideo_second = null,getvideo_third = null
                ,getvideo_fourth = null,getvideo_fifth = null,getvideo_sixth = null,getfb_icon = null,gettw_icon = null,getinsta_icon = null,getweb_icon = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_fashion_coordinator.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_name += json_data.getString("boutique_name") + ":";
                temp_profile_image += json_data.getString("boutique_profile_image") + ":";
                temp_year_active += json_data.getString("boutique_year_active") + ":";
                temp_city += json_data.getString("boutique_city") + ":";
                temp_area += json_data.getString("boutique_area") + ":";
                temp_code += json_data.getString("boutique_code") + ":";
                temp_aboutus += json_data.getString("boutique_aboutus") + ":";
                temp_image_first += json_data.getString("boutique_image_first") + ":";
                temp_image_second += json_data.getString("boutique_image_second") + ":";
                temp_image_third += json_data.getString("boutique_image_third") + ":";
                temp_image_fourth += json_data.getString("boutique_image_fourth") + ":";
                temp_image_fifth += json_data.getString("boutique_image_fifth") + ":";
                temp_image_sixth += json_data.getString("boutique_image_sixth") + ":";
                temp_gallery_first += json_data.getString("boutique_gallery_first") + ":";
                temp_gallery_second += json_data.getString("boutique_gallery_second") + ":";
                temp_gallery_third += json_data.getString("boutique_gallery_third") + ":";
                temp_gallery_fourth += json_data.getString("boutique_gallery_fourth") + ":";
                temp_gallery_fifth += json_data.getString("boutique_gallery_fifth") + ":";
                temp_gallery_sixth += json_data.getString("boutique_gallery_sixth") + ":";
                temp_video_first += json_data.getString("boutique_video_first") + ":";
                temp_video_second += json_data.getString("boutique_video_second") + ":";
                temp_video_third += json_data.getString("boutique_video_third") + ":";
                temp_video_fourth += json_data.getString("boutique_video_fourth") + ":";
                temp_video_fifth += json_data.getString("boutique_video_fifth") + ":";
                temp_video_sixth += json_data.getString("boutique_video_sixth") + ":";
                temp_fb_icon += json_data.getString("boutique_fb") + ":";
                temp_tw_icon += json_data.getString("boutique_twitter") + ":";
                temp_insta_icon += json_data.getString("boutique_insta") + ":";
                temp_web_icon += json_data.getString("boutique_web") + ":";
            ...
            getarea = Arrays.toString(arr_area).replace("[", "").replace("]", "");
        ...
        return new String[]
                {
                        getname,getprofile_image,getyear_active,getcity,getarea,getcode,getaboutus,getimage_first
