...
import com.example.gaursaurabh.faspire.ProfileCelebrityDesigner;
 ...
 */
public class CelebrityDesignerAdapter extends RecyclerView.Adapter<CelebrityDesignerAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public CelebrityDesignerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileCelebrityDesigner.class);
                intent.putExtra("celebrityDesignerId",dataLists.get(position).getId());
