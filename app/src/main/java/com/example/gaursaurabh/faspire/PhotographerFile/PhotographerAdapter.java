...
public class PhotographerAdapter extends RecyclerView.Adapter<PhotographerAdapter.ViewHolder> {
    ...
    public PhotographerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfilePhotography.class);
                intent.putExtra("photographerId",dataLists.get(position).getId());
