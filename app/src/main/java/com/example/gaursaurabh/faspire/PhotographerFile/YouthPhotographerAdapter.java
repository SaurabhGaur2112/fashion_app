...
import com.example.gaursaurabh.faspire.ProfileYouthPhotographer;
 ...
 */
public class YouthPhotographerAdapter extends RecyclerView.Adapter<YouthPhotographerAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public YouthPhotographerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileYouthPhotographer.class);
                intent.putExtra("youthPhotographerId",dataLists.get(position).getId());
