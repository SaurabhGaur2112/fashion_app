...
public class ShowVideoFlash extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_video_flash);
        ...
        firstYouTube = (YouTubePlayerView) findViewById(R.id.flashshow_video);
        headline = (TextView) findViewById(R.id.flashshow_headline_video);
        description = (TextView) findViewById(R.id.flashshow_description_video);
        ...
        if(cd.isConnected())
        {
            ...
            Toast.makeText(ShowVideoFlash.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
