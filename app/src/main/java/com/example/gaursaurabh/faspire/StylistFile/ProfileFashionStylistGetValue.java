package com.example.gaursaurabh.faspire.StylistFile;
 ...
 */
public class ProfileFashionStylistGetValue {

    public static String[] getvaluesFashionStylist(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        String temp_name = "",temp_profile_image = "",temp_year_active = "",temp_aboutus = "",temp_experience = ""
                ,temp_portfolio_first = "",temp_portfolio_second = "",temp_portfolio_third = ""
                ,temp_portfolio_fourth = "",temp_portfolio_fifth = "",temp_portfolio_sixth = ""
        ...
        String[] arr_name,arr_profile_image,arr_year_active,arr_aboutus,arr_experience
                ,arr_portfolio_first,arr_portfolio_second,arr_portfolio_third,arr_portfolio_fourth,arr_portfolio_fifth
                ,arr_portfolio_sixth,arr_gallery_first,arr_gallery_second,arr_gallery_third,arr_gallery_fourth
        ...
        String getname = null,getprofile_image = null,getyear_active = null,getaboutus = null,getexperience = null
                ...
                ,getvideo_fifth = null,getvideo_sixth = null,getcode = null
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_fashion_stylist.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_name += json_data.getString("stylist_name") + ":";
                temp_profile_image += json_data.getString("stylist_profile_image") + ":";
                temp_year_active += json_data.getString("stylist_year_active") + ":";
                temp_aboutus += json_data.getString("stylist_aboutme") + ":";
                temp_experience += json_data.getString("stylist_experience") + ":";
                temp_portfolio_first += json_data.getString("stylist_portfolio_first") + ":";
                temp_portfolio_second += json_data.getString("stylist_portfolio_second") + ":";
                temp_portfolio_third += json_data.getString("stylist_portfolio_third") + ":";
                temp_portfolio_fourth += json_data.getString("stylist_portfolio_fourth") + ":";
                temp_portfolio_fifth += json_data.getString("stylist_portfolio_fifth") + ":";
                temp_portfolio_sixth += json_data.getString("stylist_portfolio_sixth") + ":";
                temp_gallery_first += json_data.getString("stylist_gallery_first") + ":";
                temp_gallery_second += json_data.getString("stylist_gallery_second") + ":";
                temp_gallery_third += json_data.getString("stylist_gallery_third") + ":";
                temp_gallery_fourth += json_data.getString("stylist_gallery_fourth") + ":";
                temp_gallery_fifth += json_data.getString("stylist_gallery_fifth") + ":";
                temp_gallery_sixth += json_data.getString("stylist_gallery_sixth") + ":";
                temp_video_first += json_data.getString("stylist_video_first") + ":";
                temp_video_second += json_data.getString("stylist_video_second") + ":";
                temp_video_third += json_data.getString("stylist_video_third") + ":";
                temp_video_fourth += json_data.getString("stylist_video_fourth") + ":";
                temp_video_fifth += json_data.getString("stylist_video_fifth") + ":";
                temp_video_sixth += json_data.getString("stylist_video_sixth") + ":";
                temp_code += json_data.getString("stylist_code") + ":";
                temp_fb_icon += json_data.getString("stylist_fb") + ":";
                temp_tw_icon += json_data.getString("stylist_twitter") + ":";
                temp_insta_icon += json_data.getString("stylist_insta") + ":";
                temp_web_icon += json_data.getString("stylist_web") + ":";
        ...
        return new String[]
                {
                        getname,getprofile_image,getyear_active,getaboutus,getexperience,getportfolio_first
                        ,getportfolio_second,getportfolio_third,getportfolio_fourth,getportfolio_fifth,getportfolio_sixth
                        ,getgallery_first,getgallery_second,getgallery_third,getgallery_fourth,getgallery_fifth
                        ,getgallery_sixth,getvideo_first,getvideo_second,getvideo_third,getvideo_fourth
                        ,getvideo_fifth,getvideo_sixth,getcode,getfb_icon,gettw_icon,getinsta_icon,getweb_icon
                };
    }
}
