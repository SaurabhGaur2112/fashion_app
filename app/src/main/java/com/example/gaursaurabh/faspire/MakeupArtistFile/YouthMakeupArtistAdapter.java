 ...
 */
public class YouthMakeupArtistAdapter extends RecyclerView.Adapter<YouthMakeupArtistAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public YouthMakeupArtistAdapter(Context context,List<DataList> dataLists){
