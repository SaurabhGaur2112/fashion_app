 ...
 */
public class Associates extends RecyclerView.Adapter<Associates.ViewHolder> {

    private Context context;
    private List<AssociatesSponsoursList> associatesSponsoursLists;

    public Associates(Context context,List<AssociatesSponsoursList> associatesSponsoursLists){
