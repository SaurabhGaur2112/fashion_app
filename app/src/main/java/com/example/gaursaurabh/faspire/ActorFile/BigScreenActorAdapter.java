...
import com.example.gaursaurabh.faspire.ProfileBigScreenActor;
 ...
 */
public class BigScreenActorAdapter extends RecyclerView.Adapter<BigScreenActorAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public BigScreenActorAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileBigScreenActor.class);
                intent.putExtra("bigScreenActorId",dataLists.get(position).getId());
