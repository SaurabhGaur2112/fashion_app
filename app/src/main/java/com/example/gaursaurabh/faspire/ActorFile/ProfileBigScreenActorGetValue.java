 ...
 */
public class ProfileBigScreenActorGetValue {

    public static String[] getvalueBigScreenActor(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_bigscreen_actor.php");
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                temp_fb_icon += json_data.getString("actor_fb") + ":";
                temp_tw_icon += json_data.getString("actor_twitter") + ":";
                temp_insta_icon += json_data.getString("actor_insta") + ":";
                temp_web_icon += json_data.getString("actor_web") + ":";
