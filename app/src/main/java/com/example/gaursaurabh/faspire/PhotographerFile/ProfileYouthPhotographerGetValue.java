 ...
 */
public class ProfileYouthPhotographerGetValue {

    public static String[] getvaluesYouthPhotographer(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_youth_photographer.php");
