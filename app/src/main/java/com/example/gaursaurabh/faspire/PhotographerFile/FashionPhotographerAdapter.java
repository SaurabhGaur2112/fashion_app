...
import com.example.gaursaurabh.faspire.ProfileFashionStudio;
 ...
 */
public class FashionPhotographerAdapter extends RecyclerView.Adapter<FashionPhotographerAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public FashionPhotographerAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileFashionStudio.class);
                intent.putExtra("studioPhotographerId",dataLists.get(position).getId());
