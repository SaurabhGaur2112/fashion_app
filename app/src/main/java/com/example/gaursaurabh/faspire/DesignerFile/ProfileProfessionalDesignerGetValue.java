 ...
 */
public class ProfileProfessionalDesignerGetValue {

    public static String[] getvaluesProfessionalDesigner(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_professional_designer.php");
