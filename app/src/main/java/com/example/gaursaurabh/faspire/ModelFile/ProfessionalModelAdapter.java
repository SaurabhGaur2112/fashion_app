...
import com.example.gaursaurabh.faspire.ProfileProfessionalModel;
 ...
 */
public class ProfessionalModelAdapter extends RecyclerView.Adapter<ProfessionalModelAdapter.ViewHolder> {

    private Context context;
    private List<DataList> dataLists;

    public ProfessionalModelAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileProfessionalModel.class);
                intent.putExtra("professionalModelId",dataLists.get(position).getId());
