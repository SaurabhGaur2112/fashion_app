 ...
 */
public class ProfileDesignerGetValue {
    ...
    public static String[] getvaluesDesigner(String id)
    {
        ...
        String[] arr_name,arr_profile_image,arr_specilization,arr_year_active,arr_city,arr_code,
                ...
                arr_video_fourth,arr_video_fifth,arr_video_sixth;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_designer.php");
