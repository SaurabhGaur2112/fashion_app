...
import com.example.gaursaurabh.faspire.ProfileFashionStylist;
...
public class StylistAdapter extends RecyclerView.Adapter<StylistAdapter.ViewHolder> {
    ...
    public StylistAdapter(Context context,List<DataList> dataLists){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ProfileFashionStylist.class);
                intent.putExtra("fashionStylistId",dataLists.get(position).getId());
