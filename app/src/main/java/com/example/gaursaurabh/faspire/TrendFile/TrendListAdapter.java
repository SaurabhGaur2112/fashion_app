...
import com.example.gaursaurabh.faspire.ShowImageTrends;
import com.example.gaursaurabh.faspire.ShowVideoFlash;
import com.example.gaursaurabh.faspire.ShowVideoTrends;
...
public class TrendListAdapter extends BaseAdapter {
    ...
    public TrendListAdapter(Activity activity,List<FeedItem> feedItems){
    ...
    public View getView(int position, View converView, ViewGroup parent) {
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent = new Intent(activity, ShowImageTrends.class);
                    intent.putExtra("TrendId",item.getId());
                    activity.startActivity(intent);
                }
                if(item.getImageVideo().equals("video"))
                {
                    Intent intent = new Intent(activity, ShowVideoTrends.class);
                    intent.putExtra("TrendId",item.getId());
                    activity.startActivity(intent);
                }
            }
