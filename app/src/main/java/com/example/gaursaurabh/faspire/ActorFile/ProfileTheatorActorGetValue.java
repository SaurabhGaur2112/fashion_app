 ...
 */
public class ProfileTheatorActorGetValue {

    public static String[] getvalueTheatorActor(String id)
    {
        InputStream is = null;
        String line = null;
        String result = null;
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://www.faspire.in/faspire_android/profile_theator_actor.php");
